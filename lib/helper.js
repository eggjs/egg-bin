...
/**
 * format test argv then change it to array style
...
/**
 * format egg startCluster argv then change it to json string style
 * @param {String} cwd - base directory
 * @param {Object} argv - yargs style
 * @param {Object} [options] - other options
 * @param {String} [options.framework] - egg framework name or path
 * @return {Array} ['{ "port":7001,"framework":"egg"}']
 */
