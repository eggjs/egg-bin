...
class TestCommand extends Command {
  constructor(rawArgv) {
    ...
    this.options = {
      ...
      'intelli-espower-loader': {
        type: 'boolean',
        description: 'whether enable intelli-espower-loader',
        default: true,
        alias: 'i',
      },
    };
  ...
  * formatTestArgs({ argv, debugOptions }) {
    ...
    if (requireArr.includes('intelli-espower-loader')) {
      ...
      if (testArgv['intelli-espower-loader']) {
        console.log('[egg-bin] auto require `intelli-espower-loader`');
        requireArr.push(require.resolve('intelli-espower-loader'));
      } else {
        console.log('[egg-bin] no require `intelli-espower-loader`');
      }
    }
