...
class TestCommand extends Command {
  ...
  * formatTestArgs({ argv, debugOptions }) {
    ...
    } else if (!debugOptions) {
      // only add power-assert loader when not debugging due to it will disturb the debug point of IDE.
      // it seems to source-map problem, but I don't find the solotion, so just disable it.
