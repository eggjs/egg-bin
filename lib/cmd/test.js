...
class TestCommand extends Command {
  ...
  * formatTestArgs({ argv, debugOptions }) {
    ...
    // fix bug for https://github.com/eggjs/egg/issues/2315
    // need babel-plugin-espower, https://www.npmjs.com/package/babel-plugin-espower
    if (requireArr.includes('@babel/register')) {
      console.warn('[egg-bin] need `babel-plugin-espower` for @babel/register');
    } else if (requireArr.includes('intelli-espower-loader')) {
