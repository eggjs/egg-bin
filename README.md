...
- `--intelli-espower-loader` / `-i` whether enable intelli-espower-loader, default to `true`, when require intelli-espower-loader manually, this option will be neglect.
